...
import { MylistJsonld } from "./MylistJsonld";
...
export class InlineResponse20010 {
   ...
   * @class
   * @param hydramember {Array.<module:model/MylistJsonld>}
   */
...
/**
 * @member {Array.<module:model/MylistJsonld>} hydramember
 */
InlineResponse20010.prototype.hydramember = undefined;

/**
 * @member {Number} hydratotalItems
 */
InlineResponse20010.prototype.hydratotalItems = undefined;

/**
 * @member {module:model/InlineResponse200Hydraview} hydraview
 */
InlineResponse20010.prototype.hydraview = undefined;

/**
 * @member {module:model/InlineResponse200Hydrasearch} hydrasearch
 */
InlineResponse20010.prototype.hydrasearch = undefined;
