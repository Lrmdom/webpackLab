...
import { PrereservaJsonld } from "./PrereservaJsonld";
...
export class InlineResponse20014 {
   ...
   * @class
   * @param hydramember {Array.<module:model/PrereservaJsonld>}
   */
...
/**
 * @member {Array.<module:model/PrereservaJsonld>} hydramember
 */
InlineResponse20014.prototype.hydramember = undefined;

/**
 * @member {Number} hydratotalItems
 */
InlineResponse20014.prototype.hydratotalItems = undefined;

/**
 * @member {module:model/InlineResponse200Hydraview} hydraview
 */
InlineResponse20014.prototype.hydraview = undefined;

/**
 * @member {module:model/InlineResponse200Hydrasearch} hydrasearch
 */
InlineResponse20014.prototype.hydrasearch = undefined;
