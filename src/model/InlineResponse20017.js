...
import { ReservaPaymentJsonld } from "./ReservaPaymentJsonld";
...
export class InlineResponse20017 {
   ...
   * @class
   * @param hydramember {Array.<module:model/ReservaPaymentJsonld>}
   */
...
/**
 * @member {Array.<module:model/ReservaPaymentJsonld>} hydramember
 */
InlineResponse20017.prototype.hydramember = undefined;

/**
 * @member {Number} hydratotalItems
 */
InlineResponse20017.prototype.hydratotalItems = undefined;

/**
 * @member {module:model/InlineResponse200Hydraview} hydraview
 */
InlineResponse20017.prototype.hydraview = undefined;

/**
 * @member {module:model/InlineResponse200Hydrasearch} hydrasearch
 */
InlineResponse20017.prototype.hydrasearch = undefined;
