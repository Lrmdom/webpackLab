...
import { PeriodoJsonld } from "./PeriodoJsonld";
...
export class InlineResponse20012 {
   ...
   * @class
   * @param hydramember {Array.<module:model/PeriodoJsonld>}
   */
...
/**
 * @member {Array.<module:model/PeriodoJsonld>} hydramember
 */
InlineResponse20012.prototype.hydramember = undefined;

/**
 * @member {Number} hydratotalItems
 */
InlineResponse20012.prototype.hydratotalItems = undefined;

/**
 * @member {module:model/InlineResponse200Hydraview} hydraview
 */
InlineResponse20012.prototype.hydraview = undefined;

/**
 * @member {module:model/InlineResponse200Hydrasearch} hydrasearch
 */
InlineResponse20012.prototype.hydrasearch = undefined;
