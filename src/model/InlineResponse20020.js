...
import { SourcemessageJsonld } from "./SourcemessageJsonld";
...
export class InlineResponse20020 {
   ...
   * @class
   * @param hydramember {Array.<module:model/SourcemessageJsonld>}
   */
...
/**
 * @member {Array.<module:model/SourcemessageJsonld>} hydramember
 */
InlineResponse20020.prototype.hydramember = undefined;

/**
 * @member {Number} hydratotalItems
 */
InlineResponse20020.prototype.hydratotalItems = undefined;

/**
 * @member {module:model/InlineResponse200Hydraview} hydraview
 */
InlineResponse20020.prototype.hydraview = undefined;

/**
 * @member {module:model/InlineResponse200Hydrasearch} hydrasearch
 */
InlineResponse20020.prototype.hydrasearch = undefined;
