...
import { ReservaJsonld } from "./ReservaJsonld";
...
export class InlineResponse20019 {
   ...
   * @class
   * @param hydramember {Array.<module:model/ReservaJsonld>}
   */
...
/**
 * @member {Array.<module:model/ReservaJsonld>} hydramember
 */
InlineResponse20019.prototype.hydramember = undefined;

/**
 * @member {Number} hydratotalItems
 */
InlineResponse20019.prototype.hydratotalItems = undefined;

/**
 * @member {module:model/InlineResponse200Hydraview} hydraview
 */
InlineResponse20019.prototype.hydraview = undefined;

/**
 * @member {module:model/InlineResponse200Hydrasearch} hydrasearch
 */
InlineResponse20019.prototype.hydrasearch = undefined;
