...
import { ProprietarioJsonld } from "./ProprietarioJsonld";
...
export class InlineResponse20016 {
   ...
   * @class
   * @param hydramember {Array.<module:model/ProprietarioJsonld>}
   */
...
/**
 * @member {Array.<module:model/ProprietarioJsonld>} hydramember
 */
InlineResponse20016.prototype.hydramember = undefined;

/**
 * @member {Number} hydratotalItems
 */
InlineResponse20016.prototype.hydratotalItems = undefined;

/**
 * @member {module:model/InlineResponse200Hydraview} hydraview
 */
InlineResponse20016.prototype.hydraview = undefined;

/**
 * @member {module:model/InlineResponse200Hydrasearch} hydrasearch
 */
InlineResponse20016.prototype.hydrasearch = undefined;
