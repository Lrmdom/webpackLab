...
import { FeedbackJsonld } from "./FeedbackJsonld";
...
export class InlineResponse2007 {
   ...
   * @class
   * @param hydramember {Array.<module:model/FeedbackJsonld>}
   */
...
/**
 * @member {Array.<module:model/FeedbackJsonld>} hydramember
 */
InlineResponse2007.prototype.hydramember = undefined;

/**
 * @member {Number} hydratotalItems
 */
InlineResponse2007.prototype.hydratotalItems = undefined;

/**
 * @member {module:model/InlineResponse200Hydraview} hydraview
 */
InlineResponse2007.prototype.hydraview = undefined;

/**
 * @member {module:model/InlineResponse200Hydrasearch} hydrasearch
 */
InlineResponse2007.prototype.hydrasearch = undefined;
