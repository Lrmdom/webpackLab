...
import { ClienteJsonld } from "./ClienteJsonld";
...
export class InlineResponse2003 {
   ...
   * @class
   * @param hydramember {Array.<module:model/ClienteJsonld>}
   */
...
/**
 * @member {Array.<module:model/ClienteJsonld>} hydramember
 */
InlineResponse2003.prototype.hydramember = undefined;

/**
 * @member {Number} hydratotalItems
 */
InlineResponse2003.prototype.hydratotalItems = undefined;

/**
 * @member {module:model/InlineResponse200Hydraview} hydraview
 */
InlineResponse2003.prototype.hydraview = undefined;

/**
 * @member {module:model/InlineResponse200Hydrasearch} hydrasearch
 */
InlineResponse2003.prototype.hydrasearch = undefined;
