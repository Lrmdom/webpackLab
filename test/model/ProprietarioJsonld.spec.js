...
(function (root, factory) {
  ...
  describe("(package)", function () {
    describe("ProprietarioJsonld", function () {
      beforeEach(function () {
        instance = new SwaggerJsClient.ProprietarioJsonld();
      });

      it("should create an instance of ProprietarioJsonld", function () {
        // TODO: update the code to test ProprietarioJsonld
        expect(instance).to.be.a(SwaggerJsClient.ProprietarioJsonld);
      });
      ...
      it('should have the property casas (base name: "casas")', function () {
        // TODO: update the code to test the property casas
        expect(instance).to.have.property("casas");
        // expect(instance.casas).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property proprietario (base name: "proprietario")', function () {
        // TODO: update the code to test the property proprietario
        expect(instance).to.have.property("proprietario");
        // expect(instance.proprietario).to.be(expectedValueLiteral);
      });
