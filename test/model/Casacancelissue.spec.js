...
(function (root, factory) {
  ...
  describe("(package)", function () {
    describe("Casacancelissue", function () {
      beforeEach(function () {
        instance = new SwaggerJsClient.Casacancelissue();
      });

      it("should create an instance of Casacancelissue", function () {
        // TODO: update the code to test Casacancelissue
        expect(instance).to.be.a(SwaggerJsClient.Casacancelissue);
      });
