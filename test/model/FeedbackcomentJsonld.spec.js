...
(function (root, factory) {
  ...
  describe("(package)", function () {
    describe("FeedbackcomentJsonld", function () {
      beforeEach(function () {
        instance = new SwaggerJsClient.FeedbackcomentJsonld();
      });

      it("should create an instance of FeedbackcomentJsonld", function () {
        // TODO: update the code to test FeedbackcomentJsonld
        expect(instance).to.be.a(SwaggerJsClient.FeedbackcomentJsonld);
      });
      ...
      it('should have the property coment (base name: "coment")', function () {
        // TODO: update the code to test the property coment
        expect(instance).to.have.property("coment");
        // expect(instance.coment).to.be(expectedValueLiteral);
      });
