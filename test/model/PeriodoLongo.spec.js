...
(function (root, factory) {
  ...
  describe("(package)", function () {
    describe("PeriodoLongo", function () {
      beforeEach(function () {
        instance = new SwaggerJsClient.PeriodoLongo();
      });

      it("should create an instance of PeriodoLongo", function () {
        // TODO: update the code to test PeriodoLongo
        expect(instance).to.be.a(SwaggerJsClient.PeriodoLongo);
      });
