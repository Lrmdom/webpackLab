...
(function (root, factory) {
  ...
  describe("(package)", function () {
    describe("Proprietariocancelissue", function () {
      beforeEach(function () {
        instance = new SwaggerJsClient.Proprietariocancelissue();
      });

      it("should create an instance of Proprietariocancelissue", function () {
        // TODO: update the code to test Proprietariocancelissue
        expect(instance).to.be.a(SwaggerJsClient.Proprietariocancelissue);
      });
