...
(function (root, factory) {
  ...
  describe("(package)", function () {
    describe("SourcemessageJsonld", function () {
      beforeEach(function () {
        instance = new SwaggerJsClient.SourcemessageJsonld();
      });

      it("should create an instance of SourcemessageJsonld", function () {
        // TODO: update the code to test SourcemessageJsonld
        expect(instance).to.be.a(SwaggerJsClient.SourcemessageJsonld);
      });
