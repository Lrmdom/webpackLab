...
(function (root, factory) {
  ...
  describe("(package)", function () {
    describe("Cliente", function () {
      beforeEach(function () {
        instance = new SwaggerJsClient.Cliente();
      });

      it("should create an instance of Cliente", function () {
        // TODO: update the code to test Cliente
        expect(instance).to.be.a(SwaggerJsClient.Cliente);
      });
