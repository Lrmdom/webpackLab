...
(function (root, factory) {
  ...
  describe("(package)", function () {
    describe("PrereservaJsonld", function () {
      beforeEach(function () {
        instance = new SwaggerJsClient.PrereservaJsonld();
      });

      it("should create an instance of PrereservaJsonld", function () {
        // TODO: update the code to test PrereservaJsonld
        expect(instance).to.be.a(SwaggerJsClient.PrereservaJsonld);
      });
