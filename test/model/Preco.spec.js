...
(function (root, factory) {
  ...
  describe("(package)", function () {
    describe("Preco", function () {
      beforeEach(function () {
        instance = new SwaggerJsClient.Preco();
      });

      it("should create an instance of Preco", function () {
        // TODO: update the code to test Preco
        expect(instance).to.be.a(SwaggerJsClient.Preco);
      });
