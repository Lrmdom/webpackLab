...
(function (root, factory) {
  ...
  describe("(package)", function () {
    describe("FeedbackJsonld", function () {
      beforeEach(function () {
        instance = new SwaggerJsClient.FeedbackJsonld();
      });

      it("should create an instance of FeedbackJsonld", function () {
        // TODO: update the code to test FeedbackJsonld
        expect(instance).to.be.a(SwaggerJsClient.FeedbackJsonld);
      });
