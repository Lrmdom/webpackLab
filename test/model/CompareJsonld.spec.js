...
(function (root, factory) {
  ...
  describe("(package)", function () {
    describe("CompareJsonld", function () {
      beforeEach(function () {
        instance = new SwaggerJsClient.CompareJsonld();
      });

      it("should create an instance of CompareJsonld", function () {
        // TODO: update the code to test CompareJsonld
        expect(instance).to.be.a(SwaggerJsClient.CompareJsonld);
      });
