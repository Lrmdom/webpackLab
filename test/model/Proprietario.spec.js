...
(function (root, factory) {
  ...
  describe("(package)", function () {
    describe("Proprietario", function () {
      beforeEach(function () {
        instance = new SwaggerJsClient.Proprietario();
      });

      it("should create an instance of Proprietario", function () {
        // TODO: update the code to test Proprietario
        expect(instance).to.be.a(SwaggerJsClient.Proprietario);
      });
