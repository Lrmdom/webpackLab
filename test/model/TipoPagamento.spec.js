...
(function (root, factory) {
  ...
  describe("(package)", function () {
    describe("TipoPagamento", function () {
      beforeEach(function () {
        instance = new SwaggerJsClient.TipoPagamento();
      });

      it("should create an instance of TipoPagamento", function () {
        // TODO: update the code to test TipoPagamento
        expect(instance).to.be.a(SwaggerJsClient.TipoPagamento);
      });
