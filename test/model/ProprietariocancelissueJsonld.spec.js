...
(function (root, factory) {
  ...
  describe("(package)", function () {
    describe("ProprietariocancelissueJsonld", function () {
      beforeEach(function () {
        instance = new SwaggerJsClient.ProprietariocancelissueJsonld();
      });

      it("should create an instance of ProprietariocancelissueJsonld", function () {
        // TODO: update the code to test ProprietariocancelissueJsonld
        expect(instance).to.be.a(SwaggerJsClient.ProprietariocancelissueJsonld);
      });
