...
(function (root, factory) {
  ...
  describe("(package)", function () {
    describe("PeriodoLongoJsonld", function () {
      beforeEach(function () {
        instance = new SwaggerJsClient.PeriodoLongoJsonld();
      });

      it("should create an instance of PeriodoLongoJsonld", function () {
        // TODO: update the code to test PeriodoLongoJsonld
        expect(instance).to.be.a(SwaggerJsClient.PeriodoLongoJsonld);
      });
      ...
      it('should have the property precoMes (base name: "precoMes")', function () {
        // TODO: update the code to test the property precoMes
        expect(instance).to.have.property("precoMes");
        // expect(instance.precoMes).to.be(expectedValueLiteral);
      });
