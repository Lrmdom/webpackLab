...
(function (root, factory) {
  ...
  describe("(package)", function () {
    describe("ReservaJsonld", function () {
      beforeEach(function () {
        instance = new SwaggerJsClient.ReservaJsonld();
      });

      it("should create an instance of ReservaJsonld", function () {
        // TODO: update the code to test ReservaJsonld
        expect(instance).to.be.a(SwaggerJsClient.ReservaJsonld);
      });
