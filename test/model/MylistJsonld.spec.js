...
(function (root, factory) {
  ...
  describe("(package)", function () {
    describe("MylistJsonld", function () {
      beforeEach(function () {
        instance = new SwaggerJsClient.MylistJsonld();
      });

      it("should create an instance of MylistJsonld", function () {
        // TODO: update the code to test MylistJsonld
        expect(instance).to.be.a(SwaggerJsClient.MylistJsonld);
      });
